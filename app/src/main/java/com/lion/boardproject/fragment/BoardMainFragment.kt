...
class BoardMainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentBoardMainBinding.boardMainViewModel = BoardMainViewModel(this)
    ...
    fun replaceFragment(fragmentName: BoardSubFragmentName, isAddToBackStack:Boolean, animate:Boolean, dataBundle: Bundle?){
        ...
        newFragment = when(fragmentName){
            // 게시글 목록 화면
            BoardSubFragmentName.BOARD_LIST_FRAGMENT -> BoardListFragment(this)
            // 게시글 작성 화면
            BoardSubFragmentName.BOARD_WRITE_FRAGMENT -> BoardWriteFragment(this)
            // 게시글 읽기 화면
            BoardSubFragmentName.BOARD_READ_FRAGMENT -> BoardReadFragment(this)
            // 게시글 수정 화면
            BoardSubFragmentName.BOARD_MODIFY_FRAGMENT -> BoardModifyFragment(this)
            // 사용자 정보 수정 화면
            BoardSubFragmentName.USER_MODIFY_FRAGMENT -> UserModifyFragment(this)
        }
    ...
    fun settingNavigationView() {
        fragmentBoardMainBinding.apply {
            // Header 구성
            val navigationBoardMainHeaderBinding =
                DataBindingUtil.inflate<NavigationBoardMainHeaderBinding>(
