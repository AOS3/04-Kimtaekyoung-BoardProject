...
class BoardWriteFragment(val boardMainFragment: BoardMainFragment) : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentBoardWriteBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_board_write, container, false)
        fragmentBoardWriteBinding.boardWriteViewModel = BoardWriteViewModel(this)
        fragmentBoardWriteBinding.lifecycleOwner = this
