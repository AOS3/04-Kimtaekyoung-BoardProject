...
class UserJoinStep2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentUserJoinStep2Binding.userJoinStep2ViewModel = UserJoinStep2ViewModel(this)
    ...
    fun proUserJoin(){
        fragmentUserJoinStep2Binding.apply {
            ...
            val userHobby1 = userJoinStep2ViewModel?.checkBoxUserJoinStep2Hobby1Checked?.value!!
            val userHobby2 = userJoinStep2ViewModel?.checkBoxUserJoinStep2Hobby2Checked?.value!!
            val userHobby3 = userJoinStep2ViewModel?.checkBoxUserJoinStep2Hobby3Checked?.value!!
            val userHobby4 = userJoinStep2ViewModel?.checkBoxUserJoinStep2Hobby4Checked?.value!!
            val userHobby5 = userJoinStep2ViewModel?.checkBoxUserJoinStep2Hobby5Checked?.value!!
            val userHobby6 = userJoinStep2ViewModel?.checkBoxUserJoinStep2Hobby6Checked?.value!!
            val userTimeStamp = System.nanoTime()
